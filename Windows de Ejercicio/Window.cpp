...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	if (key == GLFW_KEY_R){theWindow->rotay += 10.0;} //rotar sobre el eje y 10 grados
	if (key == GLFW_KEY_T){theWindow->rotaz += 10.0;}

	//ACTIVIDAD 2.- Rotacion máxima de 45° "hacia adelante y hacia atrás", teclas independientes.
