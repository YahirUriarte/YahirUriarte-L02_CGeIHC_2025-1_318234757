...
void CrearLetrasyFiguras(){
	...
	//meshColorList[0]
	GLfloat vertices_triangulorojo[] = {//Triangulo Rojo
	//	  X		 Y	   Z	  R	  G    B
		-1.0f, -1.0f, 0.5f,	1.0f,0.0f,0.0f,
		 1.0f, -1.0f, 0.5f,	1.0f,0.0f,0.0f,
	...
	GLfloat vertices_trianguloverde[] = {//Triangulo verde, meshColorList[2] -- DE ACTIVIDAD 2
	//	  X		 Y	   Z	  R	  G	   B
	...
	//GLfloat vertices_cuadradocafe[] = {//Cuadrado cafe, meshColorList[5] -- DE ACTIVIDAD 1
	//	//	  X		 Y	   Z	   R	   G	 B
	...
	GLfloat vertices_cuadradocafe[] = {//Cuadrado cafe, meshColorList[5] -- DE ACTIVIDAD 2
		//	  X		 Y	   Z	   R	   G	 B
...
int main(){
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));//-- SE AGREGO EN CLASE.--
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		//glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		//meshList[0]->RenderMesh();

		//model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(0.0f, 2.0f, -8.0f));
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));//-- SE AGREGO EN CLASE.--
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		//glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
